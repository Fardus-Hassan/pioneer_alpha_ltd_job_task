          ...
          <div className="">
            ...
            >
                ...
                <button
                  ...
                  onClick={() => {
                    Swal.fire({
                      icon: "warning",
                      title: "Oops!",
                      text: "The forget password feature is not implemented because the API was not provided.",
                    });
                  }}
                  className="text-sm text-[#5272FF] hover:text-blue-800 transition-colors duration-200 cursor-pointer"
                >
              ...
              <button
                ...
                className="w-full bg-[#5272FF] cursor-pointer hover:bg-blue-700 text-white py-3 px-4 rounded-xl font-medium transition-all duration-200 transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {isLoading ? (
