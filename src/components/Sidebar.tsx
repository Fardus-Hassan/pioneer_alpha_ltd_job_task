    ...
    <div className="flex flex-col h-screen bg-[#0D224A] text-white w-[340px]">
      ...
      <div className="mb-[30px]">
        <button
          ...
          className="w-full cursor-pointer flex items-center gap-3 pl-[56px] py-4 transition-all duration-300 ease-in-out text-[#8CA3CD] hover:[background:linear-gradient(to_right,#1E3677_0%,#1E3677_0%,#1E3677_0%,#0D224A_80%)] hover:text-white rounded-lg"
        >
          <svg
